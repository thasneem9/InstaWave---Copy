...
{/* 
<AiFillThunderbolt   color={liked ? "rgb(237, 73, 86)" : ""} fill={liked ? "rgba(255, 255, 0, 1)" : "rgba(255, 255, 255, 1)"}  onClick={handleLike}  size={24}/> */}
{/* <FcLike   color={liked ? "rgb(237, 73, 86)" : ""} fill={liked ? "rgb(237, 73, 86)" : "rgba(255, 255, 255, 1)"}  onClick={handleLike}  size={24}/> */}
           ...
           {/*  <IoBookmarkOutline size={20} onClick={handleSave}/> */}
           ...
           <SavePostButton post={post} />
            ...
            {/* Include RepostSVG and ShareSVG components here */}
